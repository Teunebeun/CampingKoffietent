<div id="select-activityform-container" style="display: none">
    <div class="row">
        ...
        <input class="input-round-border activity-form" id="activityName" maxlength="45" type="text"
               placeholder="Voeg naam toe" name="activityName" value="{{ old('activityName') }}">
    </div>
    @error('activityName')
    <div class="error-row">
    ...
    <div class="row">
        ...
        <img id="js-image-onscreen" src="#" width="150px" height="150px">
    </div>
    ...
    <div class="row">
        ...
        <textarea class="input-round-border activity-form" id="activityDetails" type="textarea" name="activityDetails"
                  ...
                  autocomplete="off">{{ old('activityDetails') }}</textarea>
    </div>
